...
<template>
  <div class="home-hero">
    <div class="home-hero-head">
      <h1 class="home-hero-title">{{ ui.homeTitle }}</h1>
    </div>

    <div class="home-hero-notice">
      <strong>{{ ui.homeSubtitle }}</strong>
    </div>
    ...
    <div class="home-hero-actions">
      ...
      >
        ...
        <span class="home-hero-action-text">
          ...
          <span>{{ ui.homeWebsiteHint }}</span>
        </span>
        <svg class="home-hero-action-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
      ...
      <a
        :href="DISCORD_URL"
        class="home-hero-action home-hero-action--discord"
        target="_blank"
        rel="noopener noreferrer"
      >
        <span class="home-hero-action-icon home-hero-action-icon--discord">
        ...
        <span class="home-hero-action-text">
          <strong>{{ ui.homeDiscord }}</strong>
          <span>{{ ui.homeDiscordHint }}</span>
        </span>
        <svg class="home-hero-action-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
          <path d="M7 17 17 7M7 7h10v10" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
    ...
    <h2 class="home-links-heading">{{ ui.homeLinksTitle }}</h2>
  </div>
</template>
